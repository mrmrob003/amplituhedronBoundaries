...
(* ::Input::Initialization:: *)
posDimension::usage="posDimension[perm] returns the dimension (in the positive Grassmannian) of the positroid cell labelled by the affine permutation perm as computed by dimension[perm] from positroids.m."; 

topCell::usage="topCell[n,k] returns the affine permutation labelling the top cell of the positive Grassmannian \!\(\*SubscriptBox[\(G\), \(+\)]\)(k,n)."; 

isTopCellQ::usage="isTopCellQ[perm] returns True if the affine permutation perm labels the top cell of a positive Grassmanian, and otherwise False.";

posBoundary::usage="posBoundary[perm] returns all co-dimension 1 boundaries (in the positive Grassmannian) of the positroid cell labelled by the affine permutation perm as computed by boundary[perm] from positroids.m. These boundaries are given by their affine permutation labels."; 

posBoundaries::usage="posBoundaries[codim,perm] returns all boundaries of co-dimension codim (in the positive Grassmannian) of the positroid cell labelled by the affine permutation perm. These boundaries are given by their affine permutation labels."; 

posStratification::usage="posStratification[perm] returns all boundaries in the positroid stratification of the cell labelled by the affine permutation perm. These boundaries are given by their affine permutation labels."; 

posStratificationSize::usage="posStratificationSize[perm] returns the total number of boundaries in the positroid stratification of the cell labelled by the affine permutation perm.";

posInverseBoundary::usage="posInverseBoundary[perm] returns all inverse boundaries (in the positive Grassmannian) of the positroid cell labelled by the affine permutation perm as computed by inverseBoundary[perm] from positroids.m.";

posInverseBoundaries::usage="posInverseBoundaries[dim,perm] returns all cells of dimension posDimension[perm]+dim (in the positive Grassmannian) which have as one of its boundaries the positroid cell labelled by the affine permutation perm." ;

posInverseStratification::usage="posInverseStratification[perm] returns all inverse boundaries (in the positive Grassmannian) of the cell labelled by the affine permutation perm."; (* error code written *)

posInterval::usage="posInterval[perm1,perm2] returns the interval of boundaries in the positive Grassmannian contained between the positroid cells labelled by the affine permutations perm1 and perm2."; 

posPoset::usage="posPoset[perm] returns the (transitively reduced) adjacency matrix for the poset of all boundaries in the positive Grassmannian of the positroid cell labelled by the affine permutation perm.
...
posPermToLeDiagram::usage="posPermToLeDiagram[perm] returns the Le-diagram corresponding to the affine permutation perm."; 

posLeDiagramToPerm::usage="posLeDiagramToPerm[lediagram] returns the affine permutation corresponding to the Le-diagram lediagram.";
...
ampDimension::usage="ampDimension[m][perm] returns the dimension of the image (in the amplituhedron) of the positroid cell labelled by the affine permutation perm.
...
ampBoundaries::usage="ampBoundaries[m,codim][perm] returns all boundaries of co-dimension codim in the amplituhedron of the cell labelled by the affine permutation perm provided it is either a top cell or a boundary of the top cell in the amplituhedron.
...
ampStratification::usage="ampStratification[m][perm] returns the stratification of all boundaries of the cell labelled by the affine permutation perm in the amplituhedron provided perm labels either a top cell or a boundary of the top cell in the amplituhedron.
...
ampInverseStratification::usage="ampInverseStratification[m][perm] returns the stratification of all inverse boundaries of the cell labelled by the affine permutation perm in the amplituhedron provided perm labels a boundary in the amplituhedron. 
...
ampBoundary::usage="ampBoundary[m][perm] returns all co-dimension 1 boundaries (in the amplituhedron) of the cell labelled by the affine permutation perm provided perm labels a boundary in the amplituhedron.
...
ampInverseBoundary::usage="ampInverseBoundary[m][perm] returns all inverse boundaries (in the amplituhedron) with amplituhedron dimension ampDimension[m][perm]+1 of the cell labelled by the affine permutation perm provided perm labels a boundary in the amplituhedron.
...
ampInterval::usage="ampInterval[m][perm1,perm2] returns the interval of boundaries in the amplituhedron contained between the cells labelled by the affine permutations perm1 and perm2.
...
ampPoset::usage="ampPoset[m][perm] returns the (transitively reduced) adjacency matrix which defines the poset structure induced by inclusion for all boundaries (in the amplituhedron) of the cell labelled by the affine permutation perm.
...
ampPermToGraphic::usage="ampPermToGraphic[m][perm] returns the compact graphical label for the cell in the amplituhedron corresponding to the affine permutation perm.
...
ampStratificationTo3D::usage="ampStratificationTo3D[m][perm] returns a graph of connections between zero-dimensional cells in ampStratification[m][perm] provided the cell in the amplituhedron labelled by the affine permutation perm has amplituhedron dimension less than or equal to 3.
...
ampFacetsToGraph::usage="ampFacetsToGraph[m][perm] returns a star-shaped graph of the facets (co-dimension 1 boundaries) of the cell in the amplituhedron labelled by the affine permutation perm provided it is an element of the boundary stratification of the amplituhedron and it has amplituhedron dimension greater than or equal to 1.
...
momFacetsToGraph::usage="momFacetsToGraph[m][perm] returns a star-shaped graph of the facets (co-dimension 1 boundaries) of the cell in the momentum amplituhedron labelled by the affine permutation perm provided it has momentum amplituhedron dimension greater than or equal to 1.
...
ampDimensionv2e[m_/;IntegerQ[m]&&m>0][perm_/;isTopCellQ[perm]]:=(ampDimension[m][perm]=m permK[perm])
ampDimensionv2e[m_/;IntegerQ[m]&&m>0][perm_/;legalListPermQ[perm]&&posDimension[perm]==0]:=(ampDimension[m][perm]=0)
ampDimensionv2e[m_/;IntegerQ[m]&&m>0][perm_/;legalListPermQ[perm]&&perm==Global`cyclicRep[perm]]:=(ampDimension[m][perm]=Block[{k=permK[perm],n=Length[perm],randomReplacementsN=ampDefaults["N"],randomReplacements,Ymat,gauge,denom,coords,dim},
randomReplacements=Table[Table[Global`\[Alpha][A1]->RandomInteger[100],{A1,posDimension[perm]}],randomReplacementsN];
Ymat=permToMat[perm].Transpose@positiveMatrix[k+m,n];
gauge=Subsets[Range[k+m],{k}]//Select[#,And@@Table[Not[Det[(Ymat[[;;,#]]/.randomReplacements[[A2]])]==0],{A2,randomReplacementsN}]&]&//#[[1]]&;
denom=Ymat[[;;,gauge]]//Det;
coords=Subsets[Range[k+m],{k}]//Select[#,Length[Intersection[gauge,#]]==k-1&]&//Ymat[[;;,#]]&/@#&//Det/@#&;
dim=coords//#/denom&/@#&//Table[D[#,A1],{A1,Table[Global`\[Alpha][A1],{A1,posDimension[perm]}]}]&//Table[MatrixRank[#/.randomReplacements[[A1]]],{A1,randomReplacementsN}]&//Max;
ampDimensionv2e[m][perm]=dim;
dim
])/;(permK[perm]+m<=Length[perm])
ampDimensionv2e[m_/;IntegerQ[m]&&m>0][perm_/;legalListPermQ[perm]]:=(ampDimension[m][perm]=ampDimensionv2[m][Global`cyclicRep[perm]])

Options[ampDimension]={m->ampDefaults["m"],version->2,experimental->True};
...
dimFunc=Which[OptionValue[version]==1,ampDimensionv1[m],(OptionValue[version]==2)&&Not[OptionValue[experimental]],ampDimensionv2[m],True, ampDimensionv2e[m]];
...
Which[OptionValue[version]==1,ampDimensionv1[m][perm],(OptionValue[version]==2)&&Not[OptionValue[experimental]],ampDimensionv2[m][perm],True, ampDimensionv2e[m][perm]]
]
]
]/;(permK[perm]+m<=Length[perm])
...
momDimensionv2e[m_/;MemberQ[{2,4},m]][perm_/;isTopCellQ[perm]]:=(momDimension[m][perm]=m/4(2Length[perm]-m))
momDimensionv2e[m_/;MemberQ[{2,4},m]][perm_/;legalListPermQ[perm]&&(posDimension[perm]==0)]:=(momDimension[m][perm]=0)
momDimensionv2e[m_/;MemberQ[{2,4},m]][perm_/;legalListPermQ[perm]&&perm==Global`cyclicRep[perm]]:=(momDimension[m][perm]=Block[{phi={momYT[m][perm],momY[m][perm]},k=permK[perm],n=Length[perm],randomReplacementsN=momDefaults["N"],randomReplacements,dims,gauge,denom,coords,dim},
randomReplacements=Table[Table[Global`\[Alpha][A1]->RandomInteger[100],{A1,posDimension[perm]}],randomReplacementsN];
dims={k,n-k};
gauge=Table[Subsets[Range[dims[[A1]]+m/2],{dims[[A1]]}]//Select[#,And@@Table[Not[Det[(phi[[A1]][[;;,#]]/.randomReplacements[[A2]])]==0],{A2,randomReplacementsN}]&]&//#[[1]]&,{A1,2}];
denom=Table[Det[phi[[A1]][[;;,gauge[[A1]]]]],{A1,2}];
coords=Table[Subsets[Range[dims[[A1]]+m/2],{dims[[A1]]}]//Select[#,Length[Intersection[gauge[[A1]],#]]==dims[[A1]]-1&]&//phi[[A1]][[;;,#]]&/@#&//Det/@#&,{A1,2}];
dim=Table[coords[[A1]]/denom[[A1]],{A1,2}]//Flatten//Table[D[#,A1],{A1,Table[Global`\[Alpha][A2],{A2,posDimension[perm]}]}]&//Table[MatrixRank[#/.randomReplacements[[A1]]],{A1,randomReplacementsN}]&//Max;
momDimensionv2e[m][perm]=dim;
dim
])/;(m/2<=permK[perm]<=Length[perm]-m/2)
momDimensionv2e[m_/;MemberQ[{2,4},m]][perm_/;legalListPermQ[perm]]:=(momDimension[m][perm]=momDimensionv2e[m][Global`cyclicRep[perm]])

Options[momDimension]={m->momDefaults["m"],version->2,experimental->True};
...
If[!FileExistsQ[filename],
dimFunc=(*If[OptionValue[version]\[Equal]1,momDimensionv1[m],momDimensionv2[m]];*)Which[OptionValue[version]==1,momDimensionv1[m],(OptionValue[version]==2)&&Not[OptionValue[experimental]],momDimensionv2[m],True,momDimensionv2e[m]];
...
Which[OptionValue[version]==1,momDimensionv1[m][perm],(OptionValue[version]==2)&&Not[OptionValue[experimental]],momDimensionv2[m][perm],True,momDimensionv2e[m][perm]]
]
]
]/;(m/2<=permK[perm]<=Length[perm]-m/2)
...
(* ::Input::Initialization:: *)
indicesQ[n_/;IntegerQ[n]&&n>0][x__]:=And@@Flatten[Table[IntegerQ[A1]&&0<A1<=n,{A1,x}]]


(* ::Input::Initialization:: *)
momIPZeroQ[m_/;MemberQ[{2,4},m]][perm_/;legalListPermQ[perm]][indices__]:=(momIPZeroQ[m][perm][indices]=Block[{randomReplacementsN=momDefaults["N"],randomReplacements},
randomReplacements=Table[Table[Global`\[Alpha][A1]->RandomInteger[100],{A1,posDimension[perm]}],randomReplacementsN];
And@@Table[Det[(Join[momY[m][perm],Transpose@momLambda[Length[perm],permK[perm],m][[;;,{indices}]]]/.randomReplacements[[A1]])]==0,{A1,randomReplacementsN}]
])/;((m/2<=permK[perm]<=Length[perm]-m/2)&&(Length[List@indices]==m/2)&&indicesQ[Length[perm]][indices])

momIPTZeroQ[m_/;MemberQ[{2,4},m]][perm_/;legalListPermQ[perm]][indices__]:=(momIPTZeroQ[m][perm][indices]=Block[{randomReplacementsN=5,randomReplacements},
randomReplacements=Table[Table[Global`\[Alpha][A1]->RandomInteger[100],{A1,posDimension[perm]}],randomReplacementsN];
And@@Table[Det[(Join[momYT[m][perm],Transpose@momLambdaT[Length[perm],permK[perm],m][[;;,{indices}]]]/.randomReplacements[[A1]])]==0,{A1,randomReplacementsN}]
])/;((m/2<=permK[perm]<=Length[perm]-m/2)&&(Length[List@indices]==m/2)&&indicesQ[Length[perm]][indices])


(* ::Input::Initialization:: *)
momMandelstamSZeroQ[4][perm_/;legalListPermQ[perm]][i_/;IntegerQ[i]&&i>0,p_/;IntegerQ[p]]:=(momMandelstamSZeroQ[4][perm][i,p]=Block[{randomReplacementsN=5,randomReplacements,indices},
randomReplacements=Table[Table[Global`\[Alpha][A1]->RandomInteger[100],{A1,posDimension[perm]}],randomReplacementsN];
indices=Range[i,p+i]//Subsets[#,{2}]&//Mod[#-1,Length[perm]]+1&/@#&;
And@@Table[Sum[(Det[Join[momY[4][perm],Transpose@momLambda[Length[perm],permK[perm],4][[;;,A1]]]/.randomReplacements[[A2]]])(Det[Join[momYT[4][perm],Transpose@momLambdaT[Length[perm],permK[perm],4][[;;,A1]]]/.randomReplacements[[A2]]]),{A1,indices}]==0,{A2,randomReplacementsN}]
])/;(2<=permK[perm]<=Length[perm]-2&&i<=Length[perm]&&2<=p<=Length[perm]-4)
...
conseqPairs=Partition[Range[n],m/2,1,1];
mandelIndices=If[m==4,Table[{A1,A2},{A1,n},{A2,m/2,n-2-m/2}]//Flatten[#,1]&,{}];
codim1[1]=Select[candidates,
Or@@Table[momIPZeroQ[m][#]@@A1,{A1,conseqPairs}]&];
codim1[2]=Select[candidates,
Or@@Table[momIPTZeroQ[m][#]@@A1,{A1,conseqPairs}]&];
codim1[3]=If[Length[mandelIndices]==0,{},Select[candidates,Or@@Table[momMandelstamSZeroQ[4][#]@@A1,{A1,mandelIndices}]&]];
